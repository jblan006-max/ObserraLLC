...
def _paint_cover(canvas, pw, ph, title, org_name, report_date, theme, brand, version=None):
    ...
    canvas.setFillColor(colors.HexColor(date_col)); canvas.setFont("Helvetica-Oblique", 9)
    canvas.drawCentredString(pw / 2, ph * 0.395, "Discover \u00b7 understand \u00b7 govern \u00b7 constrain \u00b7 respond to enterprise AI agents")
    canvas.drawCentredString(pw / 2, ph * 0.375, "before delegated machine authority becomes enterprise risk.")
