...
def _paint_cover(canvas, pw, ph, title, org_name, report_date, theme, brand, version=None):
    ...
    canvas.drawCentredString(pw / 2, ph * 0.395, "Continuous control effectiveness, evidence assurance & framework coverage")
    canvas.drawCentredString(pw / 2, ph * 0.375, "\u2014 every metric carries its source and freshness.")
