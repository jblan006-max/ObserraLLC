...
def _evidence_markdown(snap):
    ...
    lines = [
        "## Attestation",
        f"Generated by Obserra — Agentic AI Security Control & Governance for {snap.get('org_name') or 'the organization'} "
    ...
    for room in rooms:
        try:
            ...
            html = (f"<div style='font:400 14px Arial;color:#1f2937;max-width:560px;margin:auto'>"
                    ...
                    f"<p style='font-size:11px;color:#9ca3af'>You subscribed to weekly updates for this read-only auditor room. Obserra — Agentic AI Security Control & Governance.</p></div>")
            for em in subs:
                try:
