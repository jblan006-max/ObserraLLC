...
function MetricCard({ icon: Icon, label, value, unit, accent, sub, testid }) {
  ...
  return (
    <button type="button" data-testid={testid} onClick={() => openDeepDive(detail)} onMouseEnter={() => warm(detail)} className="group w-full text-left bg-card fact-border rounded-xl p-5 cursor-pointer hover:-translate-y-0.5 transition-transform duration-200">
