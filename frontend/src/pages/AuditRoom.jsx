  ...
  return (
    <div className="min-h-screen bg-[#050810] text-white" data-testid="audit-room">
      <div className="max-w-4xl mx-auto px-5 py-10 space-y-8">
        ...
        <footer className="text-center text-[11px] text-white/30 pt-6 border-t border-white/10">Read-only evidence — generated by Obserra Cyber Crisis Commander. Link expires {fmtDT(meta?.expires_at)}.</footer>
      </div>
    </div>
  );
}
